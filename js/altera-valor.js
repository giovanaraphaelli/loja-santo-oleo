...
v1.addEventListener("click", function () {
  ...
  document.getElementById("preco4").innerHTML = "3x RS 3,27";
});
...
v2.addEventListener("click", function () {
  ...
  document.getElementById("preco4").innerHTML = "3x RS 11,78";
});
...
v3.addEventListener("click", function () {
  ...
  document.getElementById("preco4").innerHTML = "3x RS 19,48";
});
...
v4.addEventListener("click", function () {
  ...
  document.getElementById("preco4").innerHTML = "3x RS 30,06";
});
